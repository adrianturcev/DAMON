...
`:t+=`\r
`}}getPathsList(r){let t=this.damonToMap(r),e=[];return s(t),e;function s(a,o=[]){if(typeof a=="object"&&a!==null&&!Array.isArray(a)&&a instanceof Map&&a.constructor===Map)for(let[f,h]of a)typeof h=="object"&&h!==null&&!Array.isArray(h)&&h instanceof Map&&h.constructor===Map&&Array.from(h.keys()).length?(e.push(o.concat(f)),s(h,o.concat([f]))):Array.isArray(h)&&(a.damonInlineArrays==null||a.damonInlineArrays.indexOf(f)===-1)&&h.length?(e.push(o.concat(f)),s(h,o.concat([f]))):e.push(o.concat(f).concat(h));else for(let f=0,h=a.length;f<h;f++)typeof a[f]=="object"&&a[f]!==null&&!Array.isArray(a[f])&&a[f]instanceof Map&&a[f].constructor===Map&&Array.from(a[f].keys()).length?(e.push(o.concat(f)),s(a[f],o.concat([f]))):Array.isArray(a[f])&&(a.damonInlineArrays==null||a.damonInlineArrays.indexOf(f)===-1)&&a[f].length?(e.push(o.concat(f)),s(a[f],o.concat([f]))):e.push(o.concat(a[f]))}}getRangeFromPath(r,n){let t=this,e=t.damonToMap(r),s=-1,a=!1;b(e,n),e.headless&&(s-=1);let o=0,f=0;for(let g=0,m=e.damonOriginalLinesMapping.length;g<m;g++)if(e.damonOriginalLinesMapping[g]!==null&&f++,f==s){o=g+1;break}let h=t._getLines(r)[o],N=0,u=h.length;if(n.length==1)typeof n[n.length-1]=="string"?N=h.length-h.trimStart().slice(2+n[n.length-1].length+2).trimStart().length:N=h.length-h.trimStart().slice(2).length;else if(typeof n[n.length-2]=="string")if(typeof n[n.length-1]=="string")N=h.length-h.trimStart().slice(2+n[n.length-1].length+2).trimStart().length;else if(h[h.length-1]=="]"&&!/\[ *\]$/.test(h)){let g=h.trimStart().slice(2+n[n.length-2].length+2),m=JSON.parse(g),c=m.slice(0,n[n.length-1].length).reduce((E,_)=>E+(_===m[n[n.length-1]]),0),d=0,y=m[n[n.length-1]];typeof y=="string"&&(y='"'+y+'"');for(let E=0,_=c+1;E<_;E++)d=g.indexOf(y,d);N=h.length-g.length+d,u=N+y.length}else N=h.length-h.trimStart().slice(2).length;else if(typeof n[n.length-1]=="string")N=h.length-h.trimStart().slice(2+n[n.length-1].length+2).trimStart().length;else if(h[h.length-1]=="]"&&!/\[ *\]$/.test(h)){let g=h.trimStart().slice(2),m=JSON.parse(g),c=m.slice(0,n[n.length-1]).reduce((E,_)=>E+(_===m[n[n.length-1]]),0),d=0,y=m[n[n.length-1]];typeof y=="string"&&(y='"'+y+'"');for(let E=0,_=c+1;E<_;E++)d=g.indexOf(y,d);N=h.length-g.length+d,u=N+y.length}else N=h.length-h.trimStart().slice(2).length;return[[o,N],[o,u]];function b(g,m,c=[]){if(a!=!0)if(s+=1,typeof g=="object"&&g!==null&&!Array.isArray(g)&&g instanceof Map&&g.constructor===Map)for(let[d,y]of g){if(s+=1,JSON.stringify(m)===JSON.stringify(c.concat([d]))){a=!0;return}typeof y=="object"&&y!==null&&!Array.isArray(y)&&y instanceof Map&&y.constructor===Map&&Array.from(y.keys()).length?(s-=1,b(y,m,c.concat([d]))):Array.isArray(y)&&(g.damonInlineArrays==null||g.damonInlineArrays.indexOf(d)===-1)&&y.length&&(s-=1,b(y,m,c.concat([d])))}else for(let d=0,y=g.length;d<y;d++){if(s+=1,JSON.stringify(m)===JSON.stringify(c.concat([d]))){a=!0;return}typeof g[d]=="object"&&g[d]!==null&&!Array.isArray(g[d])&&g[d]instanceof Map&&g[d].constructor===Map&&Array.from(g[d].keys()).length?(s-=1,b(g[d],m,c.concat([d]))):Array.isArray(g[d])&&(g.damonInlineArrays==null||g.damonInlineArrays.indexOf(d)===-1)&&g[d].length&&(s-=1,b(g[d],m,c.concat([d])))}}}getTokenFromCoordinates(r,n){let t=this,e={},s=t._getLines(r).slice(0,n[0]);if(s[n[0]-1]=="")return e.type="newline",e.path=null,e.range=[n,n],e;if(/^[ \t]+$/.test(s[n[0]-1]))return e.type="indentation",e.path=null,e.range=[[n[0],1],[n[0],s[s.length-1].length]],e;if(/^[ \t]+/.test(s[n[0]-1].slice(0,n[1]-1))&&(e.type="indentation",e.range=[[n[0],1],[n[0],s[n[0]-1].match(/^[ \t]+/)[0].length]]),/^ *\/\//.test(s[n[0]-1]))return e.type=="indentation"?(e.path=null,e):(e.type="comment",e.path=null,e.range=[[[n[0],s[n[0]-1].split("//")[0].length]],[[n[0],s[n[0]-1].length]]],e);if(s.length==1)try{let N=JSON.parse(r);if(N===!0||N===!1||N===null||typeof N=="string"||typeof N=="number"){let u=r.match(/^ */)[0].length,b=r.match(/ *$/)[0].length;return e.type="null",typeof N!="object"&&(e.type=typeof N),e.path=null,e.range=[[0,u],[0,r.length-b]],e}}catch{}let a=t.damonToMap(s.join(`
